    ...
    viewModes: [
        {
            ...
            isActive: true,
            getSourceState: () => { return {} },
            getViewModeElement: (componentId,sourceState,cellShowing,setEditModeData,size) => <div style={{"color":"red", "fontWeight":"bold"}}>ERROR - Component not loaded!</div>
        }
    ],
